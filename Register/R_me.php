<?php
   ...
   if(isset($_POST['login'])){
    ...
    $emailp = $_POST['emailp'];
		...
		$Sql ="Select id from pinfo where emailp='$emailp'   && tname2='$tname2' ";
			...
			<div class="wrap-login100">
				...
				<br><br>
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="email" name="emailp"data-validate="Enter Email"/>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						...
						<input class="input100" type="text" name="tname2"/>
