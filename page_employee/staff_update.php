...
//$query2 ="SELECT * FROM acinfo1  WHERE acinfo1.fk_id=$id";
...
<?php
//$query3 ="SELECT * FROM acinfo2  WHERE acinfo2.fk_id=$id";

//$query3 ="SELECT p.* , a2.* FROM pinfo p,acinfo2 a2 WHERE p.id=a2.fk_id";
...
?>
		...
		// $query4 ="SELECT * FROM active1 WHERE active1.fk_id=$id";
		// $query_run4 = mysqli_query($conn, $query4);
		 
		// if($query_run4) 
		 //{ 
	// foreach($query_run4 as $row) {?>        <tr>
              <td>عنوان الورشة </td>
		<td>		
